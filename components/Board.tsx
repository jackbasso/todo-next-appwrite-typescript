...
function Board() {
  ...
  const handleOnDragEnd = (result: DropResult) => {
    ...
    if (!startCol || !finishCol) return; //No column selected don´t do anything

    if (source.index === destination.index && startCol === finishCol) return; // Moving to the same position don´t do anything
